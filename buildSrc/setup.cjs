...
run3('slink',['--debug'], getOpts('log2.ts.adligo.org'))
run3('slink',[], getOpts('log2_tests.ts.adligo.org'))
...
run3('slink',[], getOpts('tests4jXml.ts.adligo.org'))
run3('slink',[], getOpts('tests4jXml_tests.ts.adligo.org'))
